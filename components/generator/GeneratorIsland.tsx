...
import { safeWriteRecentNames, useStorageSync } from "@/hooks/useLocalStorage";
...
export function GeneratorIsland() {
  ...
  }, [addToHistory, currentName, generateName, lockState, recentNames, selectedStyle, setCurrentName]);
